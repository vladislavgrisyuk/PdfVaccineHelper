...
def get_replacement_with_time(time_before, time_after):
    ...
    #time = str(d.hours).zfill(2) + ':' + str(d.minute).zfill(2)
    rTimeHours = d.hour
    rTimeMinutes = d.minute
    time = str(rTimeHours).zfill(2) + ':' + str(rTimeMinutes).zfill(2)
    
    rTimeHours = d2.hour
    rTimeMinutes = d2.minute
    timePlus = str(rTimeHours).zfill(2) + ':' + str(rTimeMinutes).zfill(2)
    V = { 
        'Y77002287319': 'Y77002' + str(rInt),
        'Y77002287335': 'Y77002' + str(rInt + rSmall),
        '05.02.2022' : date,
